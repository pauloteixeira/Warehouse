...
function callNotify( message, type, title ) {
	...
	_titles['success'] 	= 'Muito Bem!';
	_titles['error'] 	= 'Ops... Ocorreu uma falha!';
	_titles['alert'] 	= 'Atenção!';
	_titles['info'] 	= 'Atenção!';
...
function validateEqualsNumbers( cpf )
{
    var firstNumber = cpf.charAt(0);
    var result = firstNumber*2;

    return (firstNumber * 11) != result;
}
...
function isCpf( value ) {  
    ...
    if (cpf.length == 0 || cpf.length != 11 || !validateEqualsNumbers( cpf ) || cpf == '01234567890' )
        return false;
